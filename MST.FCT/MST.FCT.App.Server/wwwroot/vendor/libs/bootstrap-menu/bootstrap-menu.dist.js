...
/******/ 	return __webpack_require__(__webpack_require__.s = "./wwwroot/vendor/libs/bootstrap-menu/bootstrap-menu.js");
/******/ })
/************************************************************************/
/******/ ({
...
eval("module.exports = __webpack_require__(/*! ./includes */ \"./node_modules/lodash/collection/includes.js\");\n\n\n//# sourceURL=webpack:///./node_modules/lodash/collection/contains.js?");
...
eval("module.exports = __webpack_require__(/*! ./forEach */ \"./node_modules/lodash/collection/forEach.js\");\n\n\n//# sourceURL=webpack:///./node_modules/lodash/collection/each.js?");
...
eval("var arrayEach = __webpack_require__(/*! ../internal/arrayEach */ \"./node_modules/lodash/internal/arrayEach.js\"),\n    baseEach = __webpack_require__(/*! ../internal/baseEach */ \"./node_modules/lodash/internal/baseEach.js\"),\n    createForEach = __webpack_require__(/*! ../internal/createForEach */ \"./node_modules/lodash/internal/createForEach.js\");\n\n/**\n * Iterates over elements of `collection` invoking `iteratee` for each element.\n * The `iteratee` is bound to `thisArg` and invoked with three arguments:\n * (value, index|key, collection). Iteratee functions may exit iteration early\n * by explicitly returning `false`.\n *\n * **Note:** As with other \"Collections\" methods, objects with a \"length\" property\n * are iterated like arrays. To avoid this behavior `_.forIn` or `_.forOwn`\n * may be used for object iteration.\n *\n * @static\n * @memberOf _\n * @alias each\n * @category Collection\n * @param {Array|Object|string} collection The collection to iterate over.\n * @param {Function} [iteratee=_.identity] The function invoked per iteration.\n * @param {*} [thisArg] The `this` binding of `iteratee`.\n * @returns {Array|Object|string} Returns `collection`.\n * @example\n *\n * _([1, 2]).forEach(function(n) {\n *   console.log(n);\n * }).value();\n * // => logs each value from left to right and returns the array\n *\n * _.forEach({ 'a': 1, 'b': 2 }, function(n, key) {\n *   console.log(n, key);\n * });\n * // => logs each value-key pair and returns the object (iteration order is not guaranteed)\n */\nvar forEach = createForEach(arrayEach, baseEach);\n\nmodule.exports = forEach;\n\n\n//# sourceURL=webpack:///./node_modules/lodash/collection/forEach.js?");
...
eval("var indexOfNaN = __webpack_require__(/*! ./indexOfNaN */ \"./node_modules/lodash/internal/indexOfNaN.js\");\n\n/**\n * The base implementation of `_.indexOf` without support for binary searches.\n *\n * @private\n * @param {Array} array The array to search.\n * @param {*} value The value to search for.\n * @param {number} fromIndex The index to search from.\n * @returns {number} Returns the index of the matched value, else `-1`.\n */\nfunction baseIndexOf(array, value, fromIndex) {\n  if (value !== value) {\n    return indexOfNaN(array, fromIndex);\n  }\n  var index = fromIndex - 1,\n      length = array.length;\n\n  while (++index < length) {\n    if (array[index] === value) {\n      return index;\n    }\n  }\n  return -1;\n}\n\nmodule.exports = baseIndexOf;\n\n\n//# sourceURL=webpack:///./node_modules/lodash/internal/baseIndexOf.js?");
...
eval("/**\n * Gets the index at which the first occurrence of `NaN` is found in `array`.\n *\n * @private\n * @param {Array} array The array to search.\n * @param {number} fromIndex The index to search from.\n * @param {boolean} [fromRight] Specify iterating from right to left.\n * @returns {number} Returns the index of the matched `NaN`, else `-1`.\n */\nfunction indexOfNaN(array, fromIndex, fromRight) {\n  var length = array.length,\n      index = fromIndex + (fromRight ? 0 : -1);\n\n  while ((fromRight ? index-- : ++index < length)) {\n    var other = array[index];\n    if (other !== other) {\n      return index;\n    }\n  }\n  return -1;\n}\n\nmodule.exports = indexOfNaN;\n\n\n//# sourceURL=webpack:///./node_modules/lodash/internal/indexOfNaN.js?");
...
eval("module.exports = __webpack_require__(/*! ./assign */ \"./node_modules/lodash/object/assign.js\");\n\n\n//# sourceURL=webpack:///./node_modules/lodash/object/extend.js?");
...
eval("var baseValues = __webpack_require__(/*! ../internal/baseValues */ \"./node_modules/lodash/internal/baseValues.js\"),\n    keys = __webpack_require__(/*! ./keys */ \"./node_modules/lodash/object/keys.js\");\n\n/**\n * Creates an array of the own enumerable property values of `object`.\n *\n * **Note:** Non-object values are coerced to objects.\n *\n * @static\n * @memberOf _\n * @category Object\n * @param {Object} object The object to query.\n * @returns {Array} Returns the array of property values.\n * @example\n *\n * function Foo() {\n *   this.a = 1;\n *   this.b = 2;\n * }\n *\n * Foo.prototype.c = 3;\n *\n * _.values(new Foo);\n * // => [1, 2] (iteration order is not guaranteed)\n *\n * _.values('hi');\n * // => ['h', 'i']\n */\nfunction values(object) {\n  return baseValues(object, keys(object));\n}\n\nmodule.exports = values;\n\n\n//# sourceURL=webpack:///./node_modules/lodash/object/values.js?");
...
eval("/**\n * A no-operation function that returns `undefined` regardless of the\n * arguments it receives.\n *\n * @static\n * @memberOf _\n * @category Utility\n * @example\n *\n * var object = { 'user': 'fred' };\n *\n * _.noop(object) === undefined;\n * // => true\n */\nfunction noop() {\n  // No operation performed.\n}\n\nmodule.exports = noop;\n\n\n//# sourceURL=webpack:///./node_modules/lodash/utility/noop.js?");
...
eval("var baseToString = __webpack_require__(/*! ../internal/baseToString */ \"./node_modules/lodash/internal/baseToString.js\");\n\n/** Used to generate unique IDs. */\nvar idCounter = 0;\n\n/**\n * Generates a unique ID. If `prefix` is provided the ID is appended to it.\n *\n * @static\n * @memberOf _\n * @category Utility\n * @param {string} [prefix] The value to prefix the ID with.\n * @returns {string} Returns the unique ID.\n * @example\n *\n * _.uniqueId('contact_');\n * // => 'contact_104'\n *\n * _.uniqueId();\n * // => '105'\n */\nfunction uniqueId(prefix) {\n  var id = ++idCounter;\n  return baseToString(prefix) + id;\n}\n\nmodule.exports = uniqueId;\n\n\n//# sourceURL=webpack:///./node_modules/lodash/utility/uniqueId.js?");

/***/ }),

/***/ "./wwwroot/vendor/libs/bootstrap-menu/bootstrap-menu.js":
/*!**************************************************************!*\
  !*** ./wwwroot/vendor/libs/bootstrap-menu/bootstrap-menu.js ***!
  \**************************************************************/
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var bootstrap_menu_src_BootstrapMenu_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! bootstrap-menu/src/BootstrapMenu.js */ \"./node_modules/bootstrap-menu/src/BootstrapMenu.js\");\n/* harmony import */ var bootstrap_menu_src_BootstrapMenu_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(bootstrap_menu_src_BootstrapMenu_js__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony reexport (module object) */ __webpack_require__.d(__webpack_exports__, \"BootstrapMenu\", function() { return bootstrap_menu_src_BootstrapMenu_js__WEBPACK_IMPORTED_MODULE_0__; });\n\n\n\n//# sourceURL=webpack:///./wwwroot/vendor/libs/bootstrap-menu/bootstrap-menu.js?");
